...
var frame = wx.Frame(nil, wx.ID_ANY, "SwiftWin32", size: wx.Size(1000, 600), style: wx.DEFAULT_FRAME_STYLE & ~wx.RESIZE_BORDER )
...
var compiler_box = wx.StaticBox(panel, wx.ID_ANY, "Answer The Following", pos: wx.Point(10, 5), size: wx.Size(965, 138))
compiler_box.setFont(font_19B)

var selected_file = wx.TextCtrl(compiler_box, wx.ID_ANY, "Are You Gay", pos:Point(20,37), size:Size(700,35), style:wx.TE_READONLY)
selected_file.setFont(font_21)
selected_file.setBackgroundColour(wx.Colour(0xFFFFFF))

var select_file_btn = wx.Button(compiler_box, id: wx.ID_ANY, label: "Choose Wisely", pos: wx.Point(725,37), 
       size: wx.Size(220,35), style:0, validator:wx.DefaultValidator, name:"buttonSelectFile")
select_file_btn.setFont(font_19B)       

var compile_button = wx.Button(compiler_box, id: wx.ID_ANY, label: "Yes", pos: Point(20,85),
       size: wx.Size(460,40), style:0, validator:wx.DefaultValidator,
       name:"buttonCompile")
compile_button.setFont(font_27)       

var run_button = wx.Button(compiler_box, id:wx.ID_ANY, label:"No", pos:Point(485,85),
       size:wx.Size(460,40), style:0, validator:wx.DefaultValidator,
       name:"buttonRun")
...
var settings_box = wx.StaticBox(panel, wx.ID_ANY, "", pos:Point(10, 150), size:Size(965, 1))
settings_box.setFont(font_19B)

var label1_static = wx.StaticText(settings_box, wx.ID_ANY, "", pos:Point(15,40), size:Size(600,35))
label1_static.setFont(font_12)

var reset_button = TextButton(settings_box, id:wx.ID_ANY, label:"", pos:Point(850,35),
       size:wx.Size(100,22))

var label2_static = wx.StaticText(settings_box, wx.ID_ANY, "", pos:Point(15,65), size:Size(1,3))
...
var logs_box = wx.StaticBox(panel, wx.ID_ANY, "", pos:Point(10, 267), size:Size(965, 1))
...
func onCompile(_ event: Event) {
  if String(swift_source.characters.suffix(6)) != ".swift" {
    _ = wx.MessageDialog(frame, "fuck of from here", "YES", style:wx.OK).showModal()
    return
  }
...
func onRun(_ event: Event) {
  if String(swift_source.characters.suffix(6)) != ".swift" {
    _ = wx.MessageDialog(frame, "🗿 You are a Giga Chad and alpha", "NO", style:wx.OK).showModal()
    return
  }
  if !wx.fileExists(swift_out_exe) {
    _ = wx.MessageDialog(frame, "fuck of from here", "Run", style:wx.OK).showModal()
    return
  }
  log_textctrl.clear()
